/**
 * This example needs a feathers service with the name cctalk that consumes messageHandlers msg objects
 * This example needs a bee-queue queue with the name jobs
 * This is a real production example 
 * 
 */
